...
<html:form name="pesquisaPromocao" type="com.nonato.spartacus.forms.PromocaoForm" action="promocao.do?acao=pesquisarPromocoes">
 <table>
  <tr>
  ...
  <tr>
   <td><html:text property="codigo" size="15" styleClass="caixaNumero" /></td>
...
function pesquisar() {
 ...
 acao( document.pesquisaPromocao );
