...
<logic:notEmpty name="empresas">
 <html:form action="regiao.do?acao=exportarEmpresa" >
 <div align="center"> 
  <table>
   <tr> 
   ...
   <tr>
    ...
    <td class="tabelaCelulaCentro">
     <a href="<%= request.getContextPath() %>/regiao.do?acao=telaInserir&empresa=<bean:write name="relatorio" property="empresa" />&empresaNome=<bean:write name="relatorio" property="empresaNome" />">
