...
<html:form name="pesquisaProduto" type="com.nonato.spartacus.forms.ProdutoForm" action="produto.do?acao=pesquisar">
<table>
  <tr>
  ...
  <tr>
   ...
   <td><html:text property="empresaNome" size="50" maxlength="60" styleClass="caixaTexto" /></td>
  </tr>
 </table>
</html:form>