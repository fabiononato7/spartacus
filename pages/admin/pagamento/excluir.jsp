...
<html:form action="pagamento.do?acao=excluir" >
 <table>
  <tr>
 ...
 <table>
  ...
  <tr>
   ...
   <td><html:text property="valor" styleClass="caixaNumero" readonly="true" /></td>
   <td><html:text property="dataPagamento" size="30" readonly="true" onkeypress="somenteNumeros()" styleClass="caixaTexto" /></td>
   <td><html:text property="valorPago" styleClass="caixaNumero" readonly="true" /></td>
  </tr>
 </table>
 <table>
  <tr>
