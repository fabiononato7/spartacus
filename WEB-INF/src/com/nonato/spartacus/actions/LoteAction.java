...
import com.nonato.spartacus.bo.LoteBO;
...
public class LoteAction extends DispatchAction {
	...
	public ActionForward inserir( ActionMapping mapping, ActionForm form,
		...
		BeanUtils.copyProperties( loteTO, loteForm );

		boolean sucesso = LoteBO.inserir( loteTO );
	...
	public ActionForward alterar( ActionMapping mapping, ActionForm form,
		...
		boolean sucesso = LoteBO.alterar( loteTO );
	...
	public ActionForward excluir( ActionMapping mapping, ActionForm form,
		...
		boolean sucesso = LoteBO.excluir( loteTO );
	...
	public LoteForm exibir( ActionForm form ) {

		LoteForm loteForm = (LoteForm) form;
		
		int codigo = Validacao.stringParaInteiro( loteForm.getCodigo() );
		
		LoteForm lote = LoteBO.listarPorCodigo( codigo );
	...
	public ActionForward telaInserir( ActionMapping mapping, ActionForm form,
		...
		loteForm.reset( mapping, request );
		
		/* refactory */
		request.setAttribute( "loteForm", loteForm );
	...
	public ActionForward telaAlterar( ActionMapping mapping, ActionForm form,
		...
		LoteForm loteForm = exibir( form );

		request.getSession().setAttribute( "loteForm", loteForm );
	...
	public ActionForward listar( ActionMapping mapping, ActionForm form,
		...
		Collection lotes = LoteBO.listar();
	...
	public ActionForward pesquisar( ActionMapping mapping, ActionForm form,
		...
		Collection lotes = LoteBO.pesquisar( loteTO );
	...
	public ActionForward listarProduto( ActionMapping mapping, ActionForm form,
			HttpServletRequest request, HttpServletResponse response ) 
			throws Exception {

		String target;
						
		Collection produtos = LoteBO.listarProdutos();
		
		request.getSession().setAttribute( "produtos", produtos );

		target = "listar_produto";
